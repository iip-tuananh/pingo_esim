...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'product', 'namespace'=>'Product'], function(){
		...
		Route::post('importExcel','ProductController@importCsvCustom');
		Route::post('add-cate-multiple','ProductController@addCateMultiple');
		Route::post('options','ProductController@listProductOptions');
		Route::post('delete-option','ProductController@deleteProductOption');
		Route::post('update-price-multiple','ProductController@updatePriceMultiple');
		Route::post('update-option','ProductController@updateOption');
		Route::get('option-detail/{id}','ProductController@getOptionDetail');
	...
	Route::group(['prefix'=>'car_service_prices'], function(){
		Route::get('list','CarServicePricesController@list');
		Route::post('store','CarServicePricesController@store');
	});
	Route::group(['prefix'=>'website','namespace'=>'Website'], function(){
		...
		Route::get('list-faq','PartnerController@listFaq');
		Route::post('faq','PartnerController@createOrUpdateFaq');
		...
		Route::post('currency-rate','CurrencyRateController@createOrUpdateCurrencyRate');
		Route::post('list-currency-rate','CurrencyRateController@listCurrencyRate');
		Route::post('delete-currency-rate','CurrencyRateController@deleteCurrencyRate');
	});
