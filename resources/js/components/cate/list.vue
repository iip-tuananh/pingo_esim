	...
	<div>
		<div class="row">
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title" @click="listCate">Danh sách phân loại</h4>
						<p class="card-description">Thêm mới hoặc sửa chửa phân loại</p>
	...
	methods: {
		...
		destroy() {
			...
			this.destroyCate({ id: this.id_item }).then(response => {
				this.listCategory();
				this.loadings(false);
				this.$notify.success('Xóa phân loại thành công');
			});
		},
		confirmDestroy(id) {
			this.id_item = id;
