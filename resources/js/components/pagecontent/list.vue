	...
	<div>
		...
		<div class="row">
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title mt-0">Danh sách trang nội dung</h4>
						...
						<vs-table max-items="5" pagination :data="list">
							...
							<template slot-scope="{ data }">
								<vs-tr :key="indextr" v-for="(tr, indextr) in data">
									...
									<vs-td :data="tr.title">{{ JSON.parse(tr.title)[0].content }}</vs-td>
									<vs-td :data="tr.type" v-if="tr.type == 'ho-tro-khach-hang'">
										Hỗ trợ khách hàng
									</vs-td>
